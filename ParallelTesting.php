...
class ParallelTesting
{
     ...
     *
     * @param  \QuantaForge\Foundation\Testing\TestCase  $testCase
     * @return void
     */
    ...
    public function option($option)
    {
        $optionsResolver = $this->optionsResolver ?: function ($option) {
            $option = 'QUANTAFORGE_PARALLEL_TESTING_'.Str::upper($option);
    ...
    {
        return ! empty($_SERVER['QUANTAFORGE_PARALLEL_TESTING']) && $this->token();
    }
}
