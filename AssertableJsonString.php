...
class AssertableJsonString implements ArrayAccess, Countable
{
     ...
     *
     * @var \QuantaForge\Contracts\Support\Jsonable|\JsonSerializable|array|string
     */
    public $json;
     ...
     *
     * @param  \QuantaForge\Contracts\Support\Jsonable|\JsonSerializable|array|string  $jsonable
     * @return void
     */
